  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created participation" do
        post :create, {:participation => valid_attributes}, valid_session
        expect(response).to redirect_to(Participation.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved participation as @participation" do
        post :create, {:participation => invalid_attributes}, valid_session
        expect(assigns(:participation)).to be_a_new(Participation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested participation" do
        participation = Participation.create! valid_attributes
        put :update, {:id => participation.to_param, :participation => new_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns the participation as @participation" do
        participation = Participation.create! valid_attributes
        put :update, {:id => participation.to_param, :participation => invalid_attributes}, valid_session
        expect(assigns(:participation)).to eq(participation)
      end
